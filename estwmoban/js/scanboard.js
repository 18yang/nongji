$(function(){
    ...
    var myMap = new AMap.Map('myMap',{
        ...
        center: [113.000923, 28.275807],
    });
    
    var point = [
    	[113.001923,28.273807],
    	[113.002923,28.279807],
    	[113.003923,28.287807]
	]
    var maker;
	...
	var option1 = {
		...
		tooltip: {
            ...
            formatter: function(params) {  
                var res = '本月'+params.name+'号订单数：'+params.data; 
                return res;  
            }  
		},
		grid: {
	...
	function setSummary(){
		...
		var barOption = {
			...
			xAxis: {
				data: ['长沙望城县乔口农机厂','长沙宁乡农机厂','长沙县团然农机'],
				axisLabel: {
	                show: true,
	                textStyle: {
	                    fontSize: '12px',
